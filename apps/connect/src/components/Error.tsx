...
export function Error({ onRetry, onCancel }: Props) {
  return (
    <div className="flex flex-col items-center justify-center h-full py-7 px-12 gap-3">
      ...
      <div className="flex flex-col w-full mt-3 gap-2.5">
        <button
          onClick={onRetry}
          className="flex items-center justify-center rounded-lg bg-cw-accent p-3.5 cursor-pointer border-none hover:bg-cw-accent-hover active:bg-cw-accent-active transition-colors"
        >
