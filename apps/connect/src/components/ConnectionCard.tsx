...
export function ConnectionCard({ connection, onClick }: Props) {
  ...
  return (
    <button
      onClick={onClick}
      className={`flex items-center gap-3.5 bg-cw-surface border border-solid border-cw-border p-4 cursor-pointer hover:border-cw-placeholder transition-colors text-left w-full rounded-xl`}
    >
