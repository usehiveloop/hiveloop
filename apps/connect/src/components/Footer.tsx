  ...
  return (
    <div className="absolute bottom-6 inset-x-0 flex items-center justify-center gap-1.5">
      <div className="flex items-center gap-1.5">
        <div className="text-[11px] leading-3.5 text-cw-secondary">
          Secured by
        </div>
        <div className="flex items-center gap-1">
          ...
          <div className="text-[12px] tracking-[-0.02em] leading-3.5 text-cw-heading connect-logo-text font-semibold">
            llmvault
          </div>
        </div>
      </div>
