      ...
      {variant === "default" ? (
        <TabsPrimitive.Indicator
          ...
          style={{
            ...
            transition:
              "top 200ms cubic-bezier(0.32,0.72,0,1), left 200ms cubic-bezier(0.32,0.72,0,1), width 200ms cubic-bezier(0.32,0.72,0,1), height 200ms cubic-bezier(0.32,0.72,0,1)",
          }}
          className={cn(
            "pointer-events-none absolute z-0 rounded-full bg-background shadow-sm transform-gpu",
            "dark:bg-input/30 dark:border dark:border-input"
          )}
        />
      ) : null}
      {children}
  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "z-10 data-active:text-foreground dark:data-active:text-foreground",
