...
function InputOTPSeparator({ ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className="flex items-center [&_svg:not([class*='size-'])]:size-4 mx-auto"
      role="separator"
      {...props}
    >
