...
interface GoogleExcelIconProps {
  className?: string
  size?: number
}

export function GoogleExcelIcon({
  className,
  size = 20,
}: GoogleExcelIconProps) {
  return (
    <div
    ...
    >
      ...
      >
        ...
        <g mask="url(#google_sheets__mask0_1:52)">
          <path
        ...
        <g mask="url(#google_sheets__mask1_1:52)">
          <path
        ...
        <g mask="url(#google_sheets__mask2_1:52)">
          <path
            d="M47.3352 25.9856L71.8905 50.5354V27.9229L47.3352 25.9856Z"
            fill="url(#google_sheets__paint0_linear_1:52)"
          />
        </g>
        <mask
          id="google_sheets__mask3_1:52"
          style={{ maskType: "alpha" }}
          maskUnits="userSpaceOnUse"
          x="1"
          y="1"
        ...
        <g mask="url(#google_sheets__mask3_1:52)">
          <path
        ...
        <g mask="url(#google_sheets__mask4_1:52)">
          <path
        ...
        <g mask="url(#google_sheets__mask5_1:52)">
          <path
        ...
        <g mask="url(#google_sheets__mask6_1:52)">
          <path
        ...
        <path
          d="M45.398 1.43036H7.86688C4.22415 1.43036 1.24374 4.41077 1.24374 8.0535V91.9465C1.24374 95.5893 4.22415 98.5697 7.86688 98.5697H65.2674C68.9101 98.5697 71.8905 95.5893 71.8905 91.9465V27.9229L45.398 1.43036Z"
          fill="url(#google_sheets__paint1_radial_1:52)"
        />
        <defs>
          <linearGradient
            id="google_sheets__paint0_linear_1:52"
            x1="59.6142"
            y1="28.0935"
            x2="59.6142"
            y2="50.5388"
          ...
          <radialGradient
            id="google_sheets__paint1_radial_1:52"
            cx="0"
            cy="0"
            r="1"
            gradientUnits="userSpaceOnUse"
