...
export function ClickupIcon({ className, size = 20 }: ClickupIconProps) {
  return (
    <div
    ...
    >
      ...
      >
        <path
          ...
          fill="url(#clickup__paint0_linear_8_569)"
        />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          ...
          fill="url(#clickup__paint1_linear_8_569)"
        />
        <defs>
          <linearGradient
            id="clickup__paint0_linear_8_569"
            x1="5.3335"
            y1="32.1624"
            x2="58.6653"
            y2="32.1624"
          ...
          <linearGradient
            id="clickup__paint1_linear_8_569"
            x1="5.3335"
            y1="31.6447"
            x2="58.6653"
            y2="31.6447"
