      ...
      <div className="flex flex-col justify-center w-full lg:w-1/2 px-6 sm:px-12 lg:px-24">
        <div className="w-full max-w-md mx-auto flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-3 mt-4 max-w-sm w-full mx-auto">
            <Button variant="outline" size="default" className="w-full h-12 cursor-pointer">
          ...
          <div className="flex items-center justify-center">
            <p className="text-xs text-muted-foreground/60 leading-relaxed">
              ...
              <a href="https://llmvault.dev" className="text-muted-foreground hover:text-foreground underline underline-offset-2 transition-colors">
                Terms of Service
              </a>{" "}
              and{" "}
              <a href="https://llmvault.dev" className="text-muted-foreground hover:text-foreground underline underline-offset-2 transition-colors">
