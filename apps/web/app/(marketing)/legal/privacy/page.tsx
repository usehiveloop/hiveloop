      ...
      <article className="max-w-2xl mx-auto px-4 pb-24">
        <div className="prose-custom flex flex-col gap-6">
          <p className="text-base sm:text-lg text-muted-foreground leading-[1.8]">
            At Hivy, we take your privacy seriously. This policy explains how we collect, use, and protect your information.
          </p>
          ...
          <p className="text-base sm:text-lg text-muted-foreground leading-[1.8]">
            You have the right to access, correct, or delete your data. You can export your data at any time through your account settings. Contact privacy@usehivy.com for requests.
          </p>
          ...
          <p className="text-base sm:text-lg text-muted-foreground leading-[1.8]">
            For privacy-related questions, contact our Data Protection Officer at privacy@usehivy.com.
          </p>
        </div>
      </article>
    </div>
