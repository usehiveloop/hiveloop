...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_usehiveloop_hiveloop_internal_model.Router"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.updateRouterRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_usehiveloop_hiveloop_internal_model.RoutingDecision"
                            }
                        }
                    },
                    "401": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_usehiveloop_hiveloop_internal_model.RouterTrigger"
                            }
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.createTriggerRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_usehiveloop_hiveloop_internal_model.RoutingRule"
                            }
                        }
                    },
                    "401": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.createRuleRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "github_com_usehiveloop_hiveloop_internal_model.Agent": {
            "type": "object",
            "properties": {
                "agentConfig": {
                ...
                "credential": {
                    "$ref": "#/definitions/github_com_usehiveloop_hiveloop_internal_model.Credential"
                },
                "credentialID": {
        ...
        "github_com_usehiveloop_hiveloop_internal_model.Credential": {
            "type": "object",
            "properties": {
                "authScheme": {
                    "type": "string"
        ...
        "github_com_usehiveloop_hiveloop_internal_model.InConnection": {
            "type": "object",
            "properties": {
                "createdAt": {
                    "type": "string"
                ...
                "inIntegration": {
                    "$ref": "#/definitions/github_com_usehiveloop_hiveloop_internal_model.InIntegration"
                },
                "inIntegrationID": {
                    "type": "string"
                },
                ...
                "user": {
                    "$ref": "#/definitions/github_com_usehiveloop_hiveloop_internal_model.User"
                },
                "userID": {
                    "type": "string"
                },
        ...
        "github_com_usehiveloop_hiveloop_internal_model.InIntegration": {
            "type": "object",
            "properties": {
                "createdAt": {
                    "type": "string"
        ...
        "github_com_usehiveloop_hiveloop_internal_model.Org": {
            "type": "object",
            "properties": {
                "active": {
                    "type": "boolean"
        ...
        "github_com_usehiveloop_hiveloop_internal_model.Router": {
            "type": "object",
            "properties": {
                "createdAt": {
                    "type": "string"
                ...
                "defaultAgent": {
                    "$ref": "#/definitions/github_com_usehiveloop_hiveloop_internal_model.Agent"
                },
                "defaultAgentID": {
                    "type": "string"
                },
        ...
        "github_com_usehiveloop_hiveloop_internal_model.RouterTrigger": {
            "type": "object",
            "properties": {
                "connectionID": {
                ...
                "inConnection": {
                    "$ref": "#/definitions/github_com_usehiveloop_hiveloop_internal_model.InConnection"
                },
                "instructions": {
        ...
        "github_com_usehiveloop_hiveloop_internal_model.RoutingDecision": {
            "type": "object",
            "properties": {
                "createdAt": {
                    "type": "string"
        ...
        "github_com_usehiveloop_hiveloop_internal_model.RoutingRule": {
            "type": "object",
            "properties": {
                "agent": {
                    "$ref": "#/definitions/github_com_usehiveloop_hiveloop_internal_model.Agent"
        ...
        "github_com_usehiveloop_hiveloop_internal_model.User": {
            "type": "object",
            "properties": {
                "banReason": {
                    "type": "string"
        ...
        "internal_handler.createRuleRequest": {
            "type": "object",
            "properties": {
                "agent_id": {
                    "type": "string"
        ...
        "internal_handler.createTriggerRequest": {
            "type": "object",
            "properties": {
                "connection_id": {
        ...
        "internal_handler.updateRouterRequest": {
            "type": "object",
            "properties": {
                "default_agent_id": {
                    "type": "string"
