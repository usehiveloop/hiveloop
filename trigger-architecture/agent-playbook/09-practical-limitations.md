...
**What you can't do**: have the agent explicitly say "this conversation I'm in should also receive events that match resource key X from now on." There's no tool like `hivy_link_resource`.
