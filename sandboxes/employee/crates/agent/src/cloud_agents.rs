...
pub fn format_cloud_agents_prompt(agents: &[CloudAgent]) -> String {
    ...
    prompt.push_str("Cloud-agent coordination is internal execution detail. In Slack, do not mention cloud agents, dedicated machines, subagents, monitoring, events, or task ids unless the user explicitly asks how Hiveloop works. Report user-visible work, blockers, and verified outcomes instead.\n");
