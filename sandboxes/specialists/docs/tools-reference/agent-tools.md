...
Fan-out is achieved by the LLM emitting multiple `sub_agent` tool_use blocks in a single assistant turn. The runtime executes them in parallel. No specialist "parallel agent" tool is needed.
