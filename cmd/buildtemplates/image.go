...
const (
	...
	// ACP harness versions must match sandboxes/specialists/docker/Dockerfile so
...
// snapshotName must match HIVY_SPECIALIST_SANDBOX_BASE_IMAGE_PREFIX in runtime config.
