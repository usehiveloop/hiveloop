...
func NewAdminHandler(db *gorm.DB, orchestrator *sandbox.Orchestrator, nangoClient *nango.Client, cat *catalog.Catalog) *AdminHandler {
	return &AdminHandler{db: db, orchestrator: orchestrator, nango: nangoClient, catalog: cat}
}
...
func toAdminSandboxTemplateResponse(t model.SandboxTemplate) adminSandboxTemplateResponse {
	return adminSandboxTemplateResponse{
		ID:          t.ID.String(),
		OrgID:       t.OrgID.String(),
		Name:        t.Name,
